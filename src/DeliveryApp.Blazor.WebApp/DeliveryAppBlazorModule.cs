...
using DeliveryApp.Blazor.WebApp.Client;
using DeliveryApp.Blazor.WebApp.Client.Menus;
using DeliveryApp.Blazor.WebApp.Components;
...
public class DeliveryAppBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("DeliveryApp");
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "29c8cdd1-8231-4a93-b137-941183625f60");
            });
        }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/DeliveryApp.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(DeliveryAppApplicationModule).Assembly);
        });
    }
